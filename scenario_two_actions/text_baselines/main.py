...
# Load the data
train_text, train_labels = prepare_data.load_data("/m/teamwork/t40511_asr/c/SLURP/speechbrain_data/scenario_two_actions/difficult_splits/train.json")
dev_text, dev_labels = prepare_data.load_data("/m/teamwork/t40511_asr/c/SLURP/speechbrain_data/scenario_two_actions/difficult_splits/dev.json")
test_text, test_labels = prepare_data.load_data("/m/teamwork/t40511_asr/c/SLURP/speechbrain_data/scenario_two_actions/difficult_splits/test.json")

# Tokenize the text
train_tokenized = tokenizer(train_text, padding=True, truncation=True, max_length=256, return_tensors='pt')
dev_tokenized = tokenizer(dev_text, padding=True, truncation=True, max_length=256, return_tensors='pt')
test_tokenized = tokenizer(test_text, padding=True, truncation=True, max_length=256, return_tensors='pt')
